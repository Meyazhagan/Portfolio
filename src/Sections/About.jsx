    ...
    return (
        <div
            ...
            <div className="space-y-4 font-poppins">
                <h2>
                    Hello, <br /> My name is <em className="font-semibold text-lg">Meyazhagan</em>
                </h2>
                <div className="text-justify space-y-4 max-w-[45ch] tracking-wide ">
                    ...
                    <p>
                        ...
                        see through a project from conception to the end product. Also I got the
                        ability to work with many frameworks, and client and server side languages.
                    </p>
                    <p>Thank you, Enjoy.</p>
                </div>
            </div>
