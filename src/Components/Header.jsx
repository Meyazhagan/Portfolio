    ...
    return (
        <>
            <div className="flex justify-between px-10 lg:px-24 py-4 fixed left-0 right-0 top-0 z-10 dark:bg-slate-900 bg-slate-50 transition-dark">
                <div className="text-xl font-special-elite tracking-wider text-slate-900 dark:text-slate-50">
                    Meyazhagan.dev
                </div>
                <div className="hidden lg:block">
                    <NavList>
                        ...
                        <a
                            href="#hire-me"
                            className="rounded-lg px-4 py-2 dark:bg-teal-600 bg-teal-500 text-white font-mono">
                            Hire Me
                        </a>
                        <button
                ...
                <div className="flex gap-4 lg:hidden">
                    <div
                        ...
                        className="rounded-lg h-full w-10 flex justify-center items-center dark:bg-teal-600 bg-teal-500 text-white font-mono">
            ...
            {open && (
                <>
                    ...
                    flex justify-center items-center dark:bg-teal-600 bg-teal-500 text-white font-mono">
